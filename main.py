...
class MainApp(ctk.CTk):
    ...
    def create_widgets(self):
        ...
        ctk.CTkButton(self.main_frame, text="Jogo de Ritmo", command=self.open_jogo).pack(pady=5)
        ctk.CTkButton(self.main_frame, text="Treino com Acordes", command=self.open_acordes).pack(pady=5)
